...
export default function ManageOrders() {
  ...
  return (
    <div className="w-full px-4 py-6">
      <h2 className="text-2xl font-bold text-black mb-6 text-center">All Orders</h2>
      {orders.length === 0 ? (
        <p className="text-black text-center">No orders found</p>
      ) : (
        <div className="overflow-x-auto">
          <table className="w-full table-auto text-sm text-left border-collapse border border-gray-700">
            <thead className="bg-[#2a2a2a] text-white">
              <tr>
                ...
                <th className="p-3 border border-gray-700">Total Items</th>
            ...
            <tbody>
              {orders.map((order) => (
                <tr key={order._id} className="text-black">
                  ...
                  <td className="p-2 border border-gray-700">{order.email}</td>
