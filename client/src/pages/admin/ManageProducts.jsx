      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {data?.data?.map((product) => (
            ...
            >
              <img
                src={product.images?.[0] || "https://images.unsplash.com/photo-1626379616459-b2ce1d9decbc?q=80&w=687&auto=format"}
                alt={product.title}
              ...
              <div className="mt-3 flex gap-3">
                <button className="text-[#d5b56e] hover:underline text-sm">
                  Edit
                </button>
